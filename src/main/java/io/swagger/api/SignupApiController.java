...
public class SignupApiController implements SignupApi {
    ...
    public @ResponseBody String registerClient(@RequestParam String name
    , @RequestParam String email, @RequestParam String password, @RequestParam Integer phone, @RequestParam Boolean isEmailConfirmed) {
